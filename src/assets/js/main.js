...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  var headerVideoHtml =
    '<video id="skm-loop" preload="auto" autoplay="true" loop="true" muted playsinline volume="0">' +
      '<source src="assets/vid/skm-loop-' + (isMobile ? 'portrait' : 'landscape') + '.mp4" type="video/mp4" codecs=avc1.42E01E,mp4a.40.2>' +
